...
function SignUp(props) {
    ...
    return (
        <div className='mt-4 shadow-lg border-2 w-[400px] px-4 py-2 flex justify-center items-center flex-col h-[350px] rounded-lg'>
            <div className='border-b  py-4 border-gray-400 flex items-center flex-col'>
                <div className='flex justify-center flex-col items-end'>
                    <div className='flex items-center'>
                        {/* <label htmlFor="">Email</label>  */}
                        <input type="email" value={emailValue} onChange={(event) => { setEmailValue(event.target.value) }} className='border-2 mx-2 p-2 w-[280px] rounded-[5px]' placeholder='Enter your email' />
                    </div>
