...
export default function Card(props) {
    ...
    return (
        <div id={props.key} onClick={goToProject} className='flex flex-col border border-slate-300 p-8 m-4 w-[425px]  rounded-md transition-transform transform hover:scale-105 hover:shadow-2xl hover:border-slate-600 cursor-pointer'>
